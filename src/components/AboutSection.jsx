...
export default function AboutSection() {
  return (
    <div className="page-container page-container--flush-top">
      <div className="section-header" data-header-image="/images/ommig.png" data-header-image-mobile="/images/ommig-mobile.png" data-nav-bg="#851F19">
      ...
      <section className="about-section content-section" id="about-section">
        <div className="about-section">
          ...
          <img className="headline-picture"src="/images/omsaraochsaragungar.png" alt="Om Sara gungar" />
            ...
            <p>Men det visade sig att det var som fiollärare jag trivdes bäst. Att kombinera de metodiker jag själv undervisats i med elevernas skiftande förutsättningar inspirerade mer än en karriär som solomusiker. Sedan dess har jag arbetat på olika musik- och kulturskolor runtom i Sverige.</p>
            <p>Givetvis fortsätter jag spela själv. Och när jag säger ”själv” menar jag oftast med andra. Både på konserter och i studio. Att hålla liv i spelandet är livsviktigt för mig.</p>
            <p>Eftersom jag lärde mig spela tidigt är musik som ett språk för mig; Ett lika naturligt sätt att uttrycka sig på som att prata. Det som började med ”Blinka lilla stjärna” och ”Sara gungar” kommer fortsätta livet ut.</p>
